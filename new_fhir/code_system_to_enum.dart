    ...
    for (final element
      ...
      if (element['binding']?['valueSet'] != null &&
        ...
        String codeSystemUrl =
            element['binding']['valueSet'].toString().split('|').first;
        ...
        enumString += '}\n\n';
        resourceEnums += enumString;
      }
    }
    await File('new_fhir/$resource.toLowerCase()}.dart')
        .writeAsString(resourceEnums);
  }
}
