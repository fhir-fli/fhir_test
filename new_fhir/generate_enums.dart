...
Future<void> main() async {
  Map<String, String> resourceEnums = {};
    ...
    for (final element
      ...
      if (element['binding']?['valueSet'] != null &&
        ...
        try {
          ...
          enumString += '}\n\n';
          resourceEnums[allTypes[resource]!] =
              (resourceEnums[allTypes[resource]!] ?? '') + enumString;
        } catch (e) {
          print('Error: $e');
        }
      }
  ...
  for (var key in resourceEnums.keys) {
    final file = File('enums/$key.enums.dart');
    file.writeAsStringSync(resourceEnums[key]!);
  }
}
